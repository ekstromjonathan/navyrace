const dictionaries = {
  en: {
    signupTitle: "Your AI coach in  iMessage",
    signupLead: "You text. Your AI coach texts back.",
    name: "Name",
    phone: "Phone",
    send: "Send  iMessage",
    tryApp: "Try the app instead",
    back: "← Back",
    consent: "By sending, you agree to be contacted by an AI coach and accept the terms.",
    terms: "Terms",
    language: "Language",
  ...
  sv: {
    signupTitle: "Din AI-coach i  iMessage",
    signupLead: "Du skriver. Din AI-coach svarar.",
    name: "Namn",
    phone: "Telefon",
    send: "Skicka  iMessage",
    tryApp: "Prova appen istället",
    back: "← Tillbaka",
    consent: "Genom att skicka godkänner du kontakt med en AI-coach och villkoren.",
    terms: "Villkor",
    language: "Språk",
  ...
  no: {
    signupTitle: "Din AI-coach på  iMessage",
    signupLead: "Du skriver. AI-coachen svarer.",
    name: "Navn",
    phone: "Telefon",
    send: "Send  iMessage",
    tryApp: "Prøv appen isteden",
    back: "← Tilbake",
    consent: "Ved å sende godtar du kontakt med en AI-coach og vilkårene.",
    terms: "Vilkår",
    language: "Språk",
